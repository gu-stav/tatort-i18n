          ...
          http
            .get( playerUrl, function( res ) {
              ...
              res.on( 'end', function( chunk ) {
                ...
                if(!downloadChild) {
                  downloadChild = xml.get( '//asset[contains(@type,"Web M HTTP")]/fileName' );
                }

                if(!downloadChild) {
                  downloadChild = xml.get( '//asset[contains(@type,"Web S VOD")]/fileName' );
                }

                if(!downloadChild) {
                  downloadChild = xml.get( '//asset[contains(@type,"Web S HTTP")]/fileName' );
                }

                if(!downloadChild) {
                  throw new Error('No Video Src found');
                }

                videoUrl = downloadChild.text();
